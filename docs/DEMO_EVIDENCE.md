...
Generated at: `2026-07-04T03:47:06.498Z`
...
M .env.example
 M README.md
 M docs/MVP_READINESS.md
 M docs/PRODUCTION_ENV_HANDOFF.md
 M package-lock.json
 M package.json
 M scripts/collect-evidence.mjs
 M scripts/db-smoke.mjs
 M scripts/demo-smoke.mjs
 M scripts/live-deployment-validate.mjs
 M scripts/live-policy-smoke.mjs
 M scripts/postgres-utils.mjs
 M scripts/readiness-audit.mjs
 M src/app/dashboard/page.tsx
 M src/app/events/[slug]/page.tsx
 M src/components/app-navigation.tsx
 M src/lib/db/client.ts
 M src/lib/db/models.ts
...
Generated pass token ID: `qpass-apac-stellar-builder-meetup-0001-31ea41`
...
|---|---|---:|---:|---|
| QuorumCore | `target/wasm32v1-none/release/quorum_core.wasm` | yes | 11189 | `784375b2d7ad722ee7beff0e660e529c7236c0b392c769e30ee989873c7f0dac` |
| QuorumPassNFT | `target/wasm32v1-none/release/quorum_pass_nft.wasm` | yes | 4620 | `7ba516f7baab9c3cb4541bbf0335cdca91f01647472d73d99363e8337b3bdd0b` |
...
{
  "event": {
    "id": "evt_a41676f0-9c32-4fe7-8ebc-a5b210877fdd",
    "slug": "smoke-a41676f0",
    "status": "draft"
  },
  "splitTotal": 100,
...
✓ Generating static pages using 15 workers (10/10) in 1196ms
...
> node scripts/wallet-auth-smoke.mjs
{
  ...
  "walletAddress": "GBJUL5UKCMTLHN66T5R3Q6NPOE2Z6JZWE6C5ZMAQXNJU4CRIVLI7Q224",
  "checks": [
...
> node scripts/demo-smoke.mjs
{
  ...
  "databaseSchema": "quorum_demo_smoke_1bf06043_84d3_4014_8604_55c336b9e74b",
  "eventId": "evt_apac_stellar_builder_meetup",
  "tokenId": "qpass-apac-stellar-builder-meetup-0001-31ea41",
  "checks": [
    "marketplace",
    "event-detail",
    "draft-validation",
...
> node scripts/browser-qa.mjs
{
  ...
  "generatedAt": "2026-07-04T03:51:35.973Z",
...
> tsx scripts/live-flow-smoke.ts
{
  ...
  "databaseSchema": "quorum_live_flow_smoke_3cfff847_52fa_4039_8b5e_535e61290c51",
  "persistedEventId": "evt_adb0c36f-5272-4ed3-8f3a-f325ab39aff1",
...
{
  "ok": true,
  "databaseSchema": "quorum_live_persistence_smoke_0c94a9c9_a3ee_476f_a8de_3146c02310f6",
  "checks": [
    "record-live-publish",
    "record-live-pass",
...
> node scripts/live-evidence-audit.mjs
{
  "ok": true,
  "mode": "template",
  "evidencePath": "D:\\AAL\\Coding\\Quorum\\docs\\LIVE_TESTNET_EVIDENCE.example.json",
  "requireFilled": false,
...
ℹ️  Build Summary:
    ...
    Wasm Size: 11189 bytes optimized (original size was 14312 bytes)
...
> node scripts/contracts/doctor.mjs
{
  ...
  "tools": {
    "stellar": {
      "ok": true,
      "version": "stellar 26.1.0 (1228cff8022b804659750b94b315932b0e0f3f6a)"
    },
    "rust": {
      "ok": true,
    ...
    "wasmArtifacts": [
      {
        ...
        "exists": true,
        "sha256": "784375b2d7ad722ee7beff0e660e529c7236c0b392c769e30ee989873c7f0dac",
        "sizeBytes": 11189
      },
      {
        "label": "QuorumPassNFT",
        ...
        "exists": true,
        "sha256": "7ba516f7baab9c3cb4541bbf0335cdca91f01647472d73d99363e8337b3bdd0b",
        "sizeBytes": 4620
      }
    ]
  },
