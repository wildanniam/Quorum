...
8. Local DB, lint, build, audit, demo smoke, live policy smoke, browser QA,
   ...
   smoke, live XDR smoke, contract tests, contract build, and deployment doctor
   checks pass with live signing exceptions documented.
