...
8. Local DB, lint, build, audit, demo smoke, live policy smoke, browser QA,
   live args smoke, live persistence smoke, live XDR smoke, contract tests,
