...
| Hackathon evidence is recorded | Verified local | `docs/DEMO_EVIDENCE.md`, `docs/BROWSER_QA.md`, and `docs/HACKATHON_DEMO_RUNBOOK.md`; `npm run live:evidence:audit:smoke` verifies filled live evidence rejects placeholders and local/non-HTTPS hosted URLs. |
